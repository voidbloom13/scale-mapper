export type InstrumentFamily = "guitar" | "bass" | "keyboard";

export type GuitarVariant = "guitar-6" | "guitar-7" | "guitar-8" | "guitar-9";
export type BassVariant = "bass-4" | "bass-5" | "bass-6";
export type KeyboardVariant = "keyboard-25" | "keyboard-49" | "keyboard-61" | "keyboard-76" | "keyboard-88";

interface GuitarVariantDefinition {
  id: GuitarVariant;
  family: "guitar";
  stringCount: 6 | 7 | 8 | 9;
  label: string;
...
interface BassVariantDefinition {
  id: BassVariant;
  family: "bass";
  stringCount: 4 | 5 | 6;
  label: string;
...
interface KeyboardVariantDefinition {
  id: KeyboardVariant;
  family: "keyboard";
