...
export const scales: Scale[] = [
    ...
    // --- DOUBLE HARMONIC MAJOR (HUNGARIAN MINOR) MODES ---
    {
        id: "double-harmonic-major",
        type: "scale",
        label: "Double Harmonic Major (Byzantine)",
        composition: ["R1", "m2", "M3", "P4", "P5", "m6", "M7"],
        tags: ["major", "exotic", "double harmonic", "bright"],
        derivesChordsFrom: true,
    },
    {
        id: "oriental",
        ...
        label: "Oriental",
        composition: ["R1", "m2", "M3", "P4", "d5", "M6", "m7"],
        tags: ["dominant", "exotic", "double harmonic", "neutral"],
        derivesChordsFrom: true,
    },
    {
        id: "ionian-sharp2-sharp5",
        type: "scale",
        label: "Ionian ♯2 ♯5",
        composition: ["R1", "A2", "M3", "P4", "A5", "M6", "M7"],
        tags: ["major", "exotic", "double harmonic", "bright"],
        derivesChordsFrom: true,
    },
    {
        ...
        composition: ["R1", "M2", "m3", "A4", "P5", "m6", "M7"],
        tags: ["minor", "exotic", "double harmonic", "dark"],
        derivesChordsFrom: true,
    },
    {
        id: "ultraphrygian",
        type: "scale",
        label: "Ultraphrygian",
        composition: ["R1", "m2", "m3", "d4", "P5", "m6", "d7"],
        tags: ["minor", "exotic", "double harmonic", "dark"],
        derivesChordsFrom: true,
    },
    {
        ...
        type: "scale",
        label: "Lydian ♯2 ♯6",
        composition: ["R1", "A2", "M3", "A4", "P5", "A6", "M7"],
        tags: ["major", "exotic", "double harmonic", "bright"],
        derivesChordsFrom: true,
    },
    {
        ...
        type: "scale",
        label: "Locrian ♭♭3 ♭♭7",
        composition: ["R1", "m2", "d3", "P4", "d5", "m6", "d7"],
        tags: ["diminished", "exotic", "double harmonic", "dark"],
        derivesChordsFrom: true,
    },
];
